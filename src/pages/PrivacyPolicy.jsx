    ...
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc list-inside text-gray-400 space-y-3 leading-relaxed">
          <li>
            <strong className="text-gray-200">Account credentials:</strong> Your email address and password, collected during
            sign-up and used solely for authentication and account management.
          </li>
          <li>
            <strong className="text-gray-200">Health data (Steps):</strong> Step count data, which may be sourced from Apple
          ...
          <li>
            <strong className="text-gray-200">Daily accountability survey responses:</strong> Answers to custom questions you
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-100 mb-3">Data Sharing and Third Parties</h2>
        <p className="text-gray-400 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-100 mb-3">HealthKit Data</h2>
        <p className="text-gray-400 leading-relaxed">
      ...
      <section className="mb-10">
        ...
        <a
          ...
          className="mt-2 inline-block text-indigo-400 font-medium hover:text-indigo-300 underline underline-offset-2"
        >
          {CONTACT_EMAIL}
        </a>
        <p className="mt-2 text-gray-400">Farzan Software Solutions Inc.</p>
      </section>
    </div>
  )
}
